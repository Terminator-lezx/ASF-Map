...
// red gate 
L.marker([61.577741, -149.134951], {icon: redGateIcon}).addTo(map).bindPopup("Red Gate Entrance into Fair Grounds");

//purple parking entrance 
L.marker([61.583065, -149.118112], {icon: purpleIcon}).addTo(map).bindPopup("Entrance to Purple Parking Lot");

//purple gate 
L.marker([61.584362, -149.1288], {icon: purpleGateIcon}).addTo(map).bindPopup("Purple Gate Entrance into Fair Grounds");

//yellow parking entrance 
L.marker([61.58119, -149.118144], {icon: yellowIcon}).addTo(map).bindPopup("Entrance to Yellow Parking Lot");

//yellow gate 
L.marker([61.581274, -149.122946], {icon: yellowGateIcon}).addTo(map).bindPopup("Yellow Gate Entrance into Fair Grounds");
